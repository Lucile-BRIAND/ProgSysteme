...
namespace AppV3
{
    public partial class GeneralSettingsView : Window
    {
        ...
        // The ComboBoxChooseLanguage_SelectionChanged method is called when the user chose a language either English or French in the related ComboBox
        ...
        // The CheckBoxExtensionToEncrypt_Checked method is called when the user click one of the 4 checkbox, for each checkbox we save the corresponding value : true for checked, false for unchecked
        // This checkbox permit us to recover the extension to encrypt related to the user's demand
        private void CheckBoxExtensionToEncrypt_Checked(object sender, RoutedEventArgs e)
        {
        ...
        // The ComboBoxMaximumFileSize_SelectionChanged method is called when the user select a value in the ComboBox, for each value we save the corresponding Maximum File Size for simultaneous transferts
        ...
        // The CheckBoxExtentionsToPrioritize_Checked method is called when the user click one of the 4 checkbox, for each checkbox we save the corresponding value : true for checked, false for unchecked
        // This checkbox permit us to recover the extension to prioritize related to the user's demand
