...
namespace Appli_V1.Controllers
{
    class RemoveJobStrategy : IStrategyController
    {
        ...
        public void CollectExistingData()
        {
            ...
            {
                removeJobStrategyView.DisplayErrorMessage(Singleton_Lang.ReadFile().Validation);//DisplayValidation
            }
            else
            {
                removeJobStrategyView.DisplayErrorMessage(Singleton_Lang.ReadFile().Error_Execute); //Show error message
            }
        }
